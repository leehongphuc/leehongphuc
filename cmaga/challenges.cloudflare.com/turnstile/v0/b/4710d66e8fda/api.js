                ...
                if (!(!n.widgetId || !y.widgetMap.has(n.widgetId))) {
                    ...
                    if (!(!i || !r)) switch (n.event) {
                        case "init":
                            {
                                ...
                                var d = r.shadow.getElementById(i);d || v("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074),
                                r.mode = n.mode,
                                r.nextRcV = n.nextRcV,
                                r.mode === z.Invisible && r.params["refresh-expired"] === J.Manual && x("refresh-expired=manual is impossible in invisible mode, consider using '".concat(J.Auto, "' or '").concat(J.Never, ".'")),
                                r.mode !== z.Managed && r.params["refresh-timeout"] !== oe.Auto && x("setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."),
                                r.params.appearance === Q.Always || r.isExecuting && r.params.appearance === Q.Execute ? Lt(d, r) : Rr(d),
                                d.style.display = "";
                                var g = r.shadow.querySelector("#".concat(i));g || v("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                (u = g.contentWindow) === null || u === void 0 || u.postMessage({
                                    event: "init",
                                    source: W,
                                    widgetId: n.widgetId
                                }, "*");
                        ...
                        case "translationInit":
                            {
                                var w = r.shadow.getElementById(i);w || v("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074);
                                var E = new Map;r.displayLanguage = n.displayLanguage,
                                Object.keys(n.translationData).forEach(function(pe) {
                        ...
                        case "requestFeedbackData":
                            {
                                var te, se = r.shadow.querySelector("#".concat(i));se || v("Received state for an unknown widget: #".concat(i, " / ").concat(n.widgetId), 3078),
                        ...
                        case "turnstileResults":
                            {
                                var xe, j, de = (xe = r.wrapper.parentNode) === null || xe === void 0 ? void 0 : xe.querySelector("#".concat(i, "-fr"));de || v("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                (j = de.contentWindow) === null || j === void 0 || j.postMessage({
                                    cfChlOut: r.cfChlOut,
                        ...
                        case "closeFeedbackReportIframe":
                            {
                                var re, we = (re = r.wrapper.parentNode) === null || re === void 0 ? void 0 : re.querySelector("#".concat(i, "-fr"));we || v("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                vr("".concat(i, "-fr"));
                                break
                            }
                        case "tokenExpired":
                            {
                                var ae, Ee = n.token;r.isExpired = !0,
                                (ae = r.cbExpired) === null || ae === void 0 || ae.call(r, Ee),
                                r.params["refresh-expired"] === J.Auto && !r.isResetting && _(H.AutoExpire, i);
                                break
                            }
                        ...
                        case "interactiveBegin":
                            {
                                var Te, Ne = r.shadow.getElementById(i);Ne || v("Cannot layout widget, Element not found (#".concat(i, ")."), 3076),
                                (Te = r.cbBeforeInteractive) === null || Te === void 0 || Te.call(r),
                                r.params.appearance === Q.InteractionOnly && Lt(Ne, r);
                                break
                            }
                        case "interactiveEnd":
                            {
                        ...
                        case "requestExtraParams":
                            {
                                var Se;r.widgetParamsStartTimeMs = U();
                                var Ae = r.shadow.querySelector("#".concat(i));Ae || v("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                r.isResetting = !1;
                                var ie = {},
                                    Ze = U(),
                                    Ie = {
