<div class="user_game_dashboard">
    <div style="display: none;" class="game_verify game_verify_phone center_div">
        <a onclick="popup_load('game/verify')">
        ...
        <div class="button_style">
            <button onclick="popup_load('game/verify')"  style="width: auto;margin: 10px auto;" class="button_yes text_button_verify"></button>
        </div>
    </div>
    <div style="display: none;" class="game_character_create game_verify center_div">
        ...
        <div class="button_style">
            ...
            <button onclick="window.open('https://doc.cmanga.com/')"  style="width: auto;margin: 10px auto;" class="button_no text_game_guide"></button>
        </div>
    </div>
    <div class="div_module">
        <div style="display: none;" class="function">
            <div class="current_balance currency_div">
                <div onclick="popup_load('game/bonus_exp')" class="item">
            ...
            <div class="list list_fr">
                <div class="item" onclick="window.open('https://doc.cmanga.com/')">
...
<script> 
    ...
    async function content_render() {
        ...
        if(time_verify < server_time){
            ...
            var function_list = ["character","skill","bag","job","shop","market","party","bank","referral","top","guild","blacksmith","gift","package","pet","friend","event"];
            html = "";
            $.each(function_list, function(key, value) {
                html += `<div class="item" onclick="load_module('content','game/function/${value}')">
            ...
            var activity_list = ["dungeon","dragon_tomb","training","legendary","angel_devil","area","word","ancient","guild_transpot","battle_doa","battle_champion","pet_champion","black_prison","guild_battle","treasure_find","battle_mine"];
            html = "";
            $.each(activity_list, function(key, value) {
                html += `<div class="item" onclick="load_module('content','game/activity/${value}')">
                            <img src="/assets/img/level/menu/${value}.png">
    ...
    //load_module('content','game/activity/battle_mine');
</script>